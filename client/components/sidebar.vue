  ...
  <div>
    <v-navigation-drawer permanent fixed clipped app>
      <v-app-bar flat class="transparent">
        <v-list v-if="loggedUser" class="pa-0">
          <v-list-item avatar>
            <v-list-item-avatar>
...
import { mdiHome, mdiPencil, mdiOfficeBuilding, mdiAccountMultiple, mdiAccountCircleOutline, mdiExitToApp, mdiMenuDown } from '@mdi/js';
